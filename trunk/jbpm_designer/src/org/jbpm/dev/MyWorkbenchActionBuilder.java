 ...
 */
public class MyWorkbenchActionBuilder extends ActionBarAdvisor {
...
//    private IContributionItem searchComboItem;
    ...
    private NewProcessAction newProcessAction;
     ...
     */
    public MyWorkbenchActionBuilder(IActionBarConfigurer configurer) {
        super(configurer);
...
//            fileToolBar.add(newWizardDropDownAction);
            ...
            fileToolBar.add(newProjectAction);
            fileToolBar.add(newProcessAction);
            fileToolBar.add(saveAction);
            fileToolBar.add(saveAllAction);
            fileToolBar.add(deleteAction);
...
//      menuBar.add(createHelpMenu());
      //去掉其他插件注册的action
        ...
        //创建自己的菜单 
        final MenuManager menuManager = new MenuManager("主菜单");
        menuBar.add(menuManager);
        final MenuManager menuManager_1 = new MenuManager("新建");
        menuManager.add(menuManager_1);
        menuManager_1.add(newProjectAction);
        menuManager_1.add(newProcessAction);
