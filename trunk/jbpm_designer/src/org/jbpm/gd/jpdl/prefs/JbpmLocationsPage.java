...
public class JbpmLocationsPage extends PreferencePage implements IWorkbenchPreferencePage, Constants {
	...
	private void editLocation() {
		...
		dialog.initialize("编辑路径", jbpmInstallation.name, jbpmInstallation.location);
