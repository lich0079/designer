...
public class TimerGeneralConfigurationComposite implements FocusListener {
	...
	private void create() {
		nameLabel = widgetFactory.createLabel(parent, "名称");
        nameText = widgetFactory.createText(parent, "");
        transitionLabel = widgetFactory.createLabel(parent, "流转");
        transitionText = widgetFactory.createText(parent, "");
        duedateLabel = widgetFactory.createLabel(parent, "持续时间");
        duedateText = widgetFactory.createText(parent, "");
        repeatLabel = widgetFactory.createLabel(parent, "重复");
