...
public class AsyncableElementSection extends AbstractPropertySection {
	...
	public void createControls(Composite parent,
        ...
        asyncableElementConfigurationComposite = AsyncableElementConfigurationComposite.create(getWidgetFactory(), clientArea);
    }
 	...
 	public void setInput(IWorkbenchPart part, ISelection selection) {
        ...
        if (input instanceof AsyncableElement) {
        	setAsyncableElement((AsyncableElement)input);
        }
    }
 	
 	private void setAsyncableElement(AsyncableElement asyncableElement) {
 		this.asyncableElement = asyncableElement;
 	}

 	public void refresh() {
 		if (asyncableElement != null) {
 			asyncableElementConfigurationComposite.setAsyncableElement(asyncableElement);
 		}
    }
}