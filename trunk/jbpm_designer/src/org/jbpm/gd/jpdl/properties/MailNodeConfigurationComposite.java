...
public class MailNodeConfigurationComposite implements SelectionListener, FocusListener {
	...
	private void create() {
		templateLabel = widgetFactory.createLabel(parent, "模板");
		...
		actorsButton = widgetFactory.createButton(parent, "执行者", SWT.RADIO);
		actorsText = widgetFactory.createText(parent, "");
		actorsText.setEnabled(false);
		subjectLabel = widgetFactory.createLabel(parent, "主题");
		subjectText = widgetFactory.createText(parent, "");
		bodyLabel = widgetFactory.createLabel(parent, "正文");
