...
public class ActionElementOutlineEditPart extends OutlineEditPart {
	
	public ActionElementOutlineEditPart(ActionElement actionElement) {
		super(actionElement);
	}
	
	private ActionElement getActionElement() {
		return (ActionElement)getModel();
	}
	
	protected String getText() {
		return getLabel(getActionElement());
	}
