...
public class EdgeDeleteCommand extends AbstractEdgeDeleteCommand {
	...
	public void execute() {
		((NodeElement)source.getSemanticElement()).removeTransition((Transition)edge.getSemanticElement());
	}
	
	public void undo() {
		edge.register();
		((NodeElement)source.getSemanticElement()).addTransition((Transition)edge.getSemanticElement());
	}
