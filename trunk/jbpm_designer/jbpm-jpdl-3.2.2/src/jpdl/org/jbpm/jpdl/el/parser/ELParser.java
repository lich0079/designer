 ...
 **/
  ...
  public ELToken token, jj_nt;
  private int jj_ntk;
  private ELToken jj_scanpos, jj_lastpos;
  private int jj_la;
  ...
  final private ELToken jj_consume_token(int kind) throws ParseException {
    ELToken oldToken;
  ...
  final public ELToken getNextToken() {
  ...
  final public ELToken getToken(int index) {
    ELToken t = lookingAhead ? jj_scanpos : token;
