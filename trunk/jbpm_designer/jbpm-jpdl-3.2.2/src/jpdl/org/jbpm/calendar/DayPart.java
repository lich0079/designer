...
public class DayPart implements Serializable {
  ...
  public Date add(Date date, Duration duration) {
    ...
    if (duration.milliseconds <= millisecondsInThisDayPart) {
      ...
      long remainderMillis = duration.milliseconds - millisecondsInThisDayPart;
      Duration remainder = new Duration(remainderMillis);
      Date dayPartEndDate = new Date(date.getTime() + duration.milliseconds - remainderMillis);
