...
public class ControllerConfigurationComposite implements SelectionListener, FocusListener {
	...
	private void create() {
		...
		controllerTypeCombo.setItems(new String[] {"<请选择>", "默认", "定制"});
