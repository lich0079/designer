...
public class VariableContainerConfigurationComposite implements SelectionListener {
	...
	public static VariableContainerConfigurationComposite create(FormToolkit widgetFactory, Composite parent) {
		return create(widgetFactory, parent, false, new String[] {"名称", "映射名", "可读", "可写", "需求"});
	}
	...
	private void create() {
		messageLabel = widgetFactory.createLabel(parent, "定义使用的变量 :");
		...
		removeButton = widgetFactory.createButton(parent, "移除", SWT.PUSH);
