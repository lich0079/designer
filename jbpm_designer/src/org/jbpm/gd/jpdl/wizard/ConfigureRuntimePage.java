...
public class ConfigureRuntimePage extends WizardPage {
	...
	private static final String ENTER_NAME_MSG = "请为 JBoss jBPM 运行时环境输入名字, 如. 'JBoss jBPM 3.1.1'";
	private static final String ENTER_LOCATION_MSG = "请为 JBoss jBPM 运行时环境输入路径";
	private static final String CONTINUE_MSG = "点击next继续";
	private static final String UNEXISTING_LOCATION_MSG = "路径不存在";
	private static final String INVALID_LOCATION_MSG = "路径没有包含一个有效的 JBoss jBPM,请重试 ";
	
	Text nameText, locationText, versionText;
	
	public ConfigureRuntimePage() {
		super("配置 JBoss jBPM ");
		setTitle("配置 JBoss jBPM");
	...
	private void createDownloadJbpmRuntimeLink(Composite composite) {
		...
		link.setText("<a>如果你没有可用的jBPM请下载.</a>");
