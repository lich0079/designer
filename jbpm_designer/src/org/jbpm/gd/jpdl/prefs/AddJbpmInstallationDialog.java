...
public class AddJbpmInstallationDialog extends StatusDialog {
	...
	private void updateCurrentStatus() {
		...
		} else if (isNameAlreadyUsed() && !"编辑路径".equals(title)) {
